...
// import voxCatTitle from "public/images/vox-cat-title.png";
    ...
    <div className={`${styles.wrapper}`}>
      <div className="container-wrapper">
        <main>
          ...
          <img
            src="/images/hero-bgs/cat.png"
            className={`${styles.bg_cat}`}
            alt=""
          />
        </main>

        {/* <Modal img=img="images/cat4.png"} shouldShow={showModal} setModalState={setShowModal}>
          <h1 className="fs-26px white weight-9 uppercase">
            SORRY...YOU'RE NOT ON THE WHITELIST.
          </h1>
        </Modal> */}

        {/* <Modal img="images/cat1.png" shouldShow={showModal} setModalState={setShowModal}>
          <h1 className="fs-26px white weight-9 uppercase">
            <span className="yellow">YAY!</span> YOU ARE WHITELISTED!
          </h1>
        </Modal> */}

        {/* <Modal img="images/cat4.png" shouldShow={showModal} setModalState={setShowModal}>
          <h1 className="fs-26px white weight-9 uppercase">
