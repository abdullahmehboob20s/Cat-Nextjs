  ...
  return (
    <div className={`${styles.wrapper}`}>
      <div className="container-wrapper py-100px">
        ...
        <main>
          <HowToMintCard
            circleImg={<img src="/images/metamask-logo.png" alt="img" />}
            circleBg="white"
          >
          ...
          <HowToMintCard
            circleImg={<img src="/images/check-icon.png" alt="img" />}
            circleBg="#83b784"
          >
            <p className="text-center white fs-18px weight-4">
          ...
          <HowToMintCard
            circleImg={<img src="/images/wallet-icon.png" alt="img" />}
            circleBg="#a36969"
          >
            <p className="text-center white fs-18px weight-4">
          ...
          <HowToMintCard
            circleImg={<img src="/images/lightning-icon.png" alt="img" />}
            circleBg="#e19a12"
          >
            <p className="text-center white fs-18px weight-4">
