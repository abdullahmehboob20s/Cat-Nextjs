  ...
  return (
    <div className={`${styles.wrapper}`}>
      <div className="container-wrapper py-100px">
        ...
        <main>
          <FamilyCard
            title="Boss Cat Rocket Club"
            img="/images/familyImg1.png"
          />
          <FamilyCard
            title="Boss Cat Rocket Parts"
            img="/images/familyImg2.png"
          />
          <FamilyCard title="Boss Planet" img="/images/familyImg3.png" />
        </main>
      </div>
    </div>
  );
