  ...
  return (
    <div className={`${styles.wrapper}`}>
      <img
        ...
        alt=""
        className={`${styles.img1} w-full`}
      />
      <img
        src="/images/gridImg2.png"
        alt=""
        className={`${styles.img2} w-full`}
      />
      <img
        src="/images/gridImg3.png"
        alt=""
        className={`${styles.img3} w-full`}
      />
      <img
        src="/images/gridImg4.png"
        alt=""
        className={`${styles.img4} w-full`}
      />
      <img
        src="/images/gridImg5.png"
        alt=""
        className={`${styles.img5} w-full`}
      />
      <img
        src="/images/gridImg6.png"
        alt=""
        className={`${styles.img6} w-full`}
      />
      <img
        src="/images/gridImg7.png"
        alt=""
        className={`${styles.img7} w-full`}
      />
      <img
        src="/images/gridImg8.png"
        alt=""
        className={`${styles.img8} w-full`}
      />
      <main>
        <section>
